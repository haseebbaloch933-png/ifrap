...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    nav: {
      ...
      appTitle: 'MIRAB',
      appSubtitle: 'IFRAP Operations & Results Backbone',
      skipToContent: 'Skip to main content',
    },
    map: {
      title: 'Participatory Spatial Layer Control',
      subtitle: 'Balochistan Karez Systems & Customary Water Management',
      layerControl: 'Layer View Mode',
      technocratic: 'Technocratic Standard',
      decolonial: 'Customary Knowledge Layer',
      center: 'Center',
    ...
    telemetry: {
      ...
      subtitle: 'Quantitative M&E monitoring of Balochistan Karez Rehabilitation & Community Water Management (IFRAP Programme). Evaluates capability deprivation (MPI = H × A) across water infrastructure, customary governance, climate resilience, and economic sustainability.',
      badge: 'IFRAP Programme • M&E Telemetry Engine',
      ...
      ifrapMetrics: 'IFRAP Programme Capability Metrics',
    ...
    grm: {
      ...
      subtitle: 'IFRAP Programme • Complaint Tracking & Resolution Ledger',
    ...
    admin: {
      ...
      subtitle: 'IFRAP Programme • FPMU Director Overview',
  ...
  ur: {
    nav: {
      ...
      appTitle: 'میراب',
      appSubtitle: 'آئی ایف آر اے پی آپریشنز اور رزلٹس پلیٹ فارم',
      skipToContent: 'بنیادی مواد پر جائیں',
    },
    map: {
      title: 'شراکتی جغرافیائی لیئر کنٹرول',
      subtitle: 'بلوچستان کاریز کا نظام اور روایتی پانی کا انتظام',
      layerControl: 'لیئر کا انداز',
      technocratic: 'ٹیکنو کریٹک معیاری',
      decolonial: 'روایتی/آبائی علم لیئر',
      center: 'مرکز',
      zoomLevel: 'زوم لیول',
